...
export const CREATE_COMMENT_ON_ARTICLE_START = 'CREATE_COMMENT_ON_ARTICLE_START';
export const CREATE_COMMENT_ON_ARTICLE_SUCCESS = 'CREATE_COMMENT_ON_ARTICLE_SUCCESS';
